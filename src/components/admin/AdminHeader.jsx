...
const AdminHeader = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0  bg-white px-3 sm:px-4 md:px-8 py-3 sm:py-4 border-b border-gray-100 z-20 ">
        <div className="flex items-center  justify-between  relative z-20">
          <div className="md:flex items-center hidden lg:ms-[260px]">
            {/* search */}
            <div className="relative max-w-md mx-auto ">
              <span className="absolute inset-y-0  flex items-center pl-2  text-gray-400">
                <CiSearch />
              </span>
              <input
                type="text"
